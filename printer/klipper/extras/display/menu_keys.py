...
class MenuKeys:
    ...
    def encoder_cw_callback(self, eventtime):
        ...
        self.printer.send_event("menu_keys:cw_encoder", eventtime)
    ...
    def encoder_ccw_callback(self, eventtime):
        ...
        self.printer.send_event("menu_keys:ccw_encoder", eventtime)

    # Click handling
    def long_click_event(self, eventtime):
        self.is_short_click = False
        self.callback('long_click', eventtime)
        self.printer.send_event("menu_keys:long_click", eventtime)
    ...
    def click_callback(self, eventtime, state):
        ...
        self.printer.send_event("menu_keys:click", eventtime)
